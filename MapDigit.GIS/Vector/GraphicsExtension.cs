...
namespace MapDigit.GIS.Vector
{
    ...
    internal enum TextPathPosition
    {
        OverPath = 0,
        CenterPath = 1,
        UnderPath = 2
    ...
    internal static class GraphicsExtension
    {
        ...
        internal static RectangleF[] MeasureString(this Graphics graphics, string s, Font font, Brush brush, GraphicsPath graphicsPath)
        {
            return MeasureString(graphics, s, font, brush, TextPathAlign.Center, TextPathPosition.CenterPath, 100, graphicsPath);
        }

        internal static RectangleF[] MeasureString(this Graphics graphics, string s, Font font, Brush brush, TextPathAlign textPathAlign, TextPathPosition textPathPosition, GraphicsPath graphicsPath)
        {
            return MeasureString(graphics, s, font, brush, textPathAlign, textPathPosition, 100, graphicsPath);
        }

        internal static void DrawString(this Graphics graphics, string s, Font font, Brush brush, GraphicsPath graphicsPath)
        {
        ...
        internal static void DrawString(this Graphics graphics, string s, Font font, Color fontColor,Brush brush, TextPathAlign textPathAlign, TextPathPosition textPathPosition, int letterSpace, float rotateDegree, GraphicsPath graphicsPath)
        {
            TEXT_ON_PATH.Text = s;
            TEXT_ON_PATH.Font = font;
            TEXT_ON_PATH.Color = fontColor;
            TEXT_ON_PATH.FillColorTop = brush;
            TEXT_ON_PATH.TextPathPathPosition = textPathPosition;
            TEXT_ON_PATH.TextPathAlignTop = textPathAlign;
            TEXT_ON_PATH.PathDataTop = graphicsPath.PathData;
    ...
    internal class TextOnPath
    {
        ...
        internal readonly List<RectangleF> _regionList = new List<RectangleF>();
        internal float _rotateDegree;
        internal TextPathPosition TextPathPathPosition
        {
            get { return _textPathPathPosition; }
            set { _textPathPathPosition = value; }
        }
        internal PathData PathDataTop
        {
        ...
        internal Brush FillColorTop
        {
            get { return _fillBrush; }
            set { _fillBrush = value; }
        }

        internal TextPathAlign TextPathAlignTop
        {
            get { return _pathalign; }
            set { _pathalign = value; }
        }

        internal int LetterSpacePercentage
        {
        ...
        private RectangleF StringRegionValue(Graphics g, int textpos)
        {
            ...
            SizeF size = g.MeasureString(_text, _font, 0);
        ...
        private void DrawRotatedText(Graphics gr, string text, float angle, PointF pointCenter)
        {
            ...
            float fontHeight = (float)(_font.Height );
            switch (TextPathPathPosition)
            {
                case TextPathPosition.OverPath:
                    graphicsPath.AddString(text, _font.FontFamily, (int)_font.Style, fontHeight, new Point(x, (int)(y - _font.Size)), stringFormat);
                    break;
                case TextPathPosition.CenterPath:
                    graphicsPath.AddString(text, _font.FontFamily, (int)_font.Style, fontHeight, new Point(x, (int)(y - _font.Size / 2)), stringFormat);
                    break;
                case TextPathPosition.UnderPath:
                    graphicsPath.AddString(text, _font.FontFamily, (int)_font.Style, fontHeight, new Point(x, y), stringFormat);
                    break;
            }
        ...
        private static PointF[] GetLinePoints(PointF p1, PointF p2, int stepWitdth)
        {
